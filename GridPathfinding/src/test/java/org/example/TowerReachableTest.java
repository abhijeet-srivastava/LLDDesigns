...
@DisplayName("TowerReachable.calculate")
class TowerReachableTest {

    private final TowerReachable solver = new TowerReachable();
    ...
    @Test
    @DisplayName("Simple subtraction1")
    void simpleSubtraction1() {
        assertThat(solver.calculate("x = 28 - 21")).isEqualTo(7);
    }
    ...
    @Test
    @DisplayName("Parentheses override default precedence with unary")
    void parenthesesOverridePrecedenceWithUnary() {
        assertThat(solver.calculate("x = (-2 + 3) * 4")).isEqualTo(4);
    }
